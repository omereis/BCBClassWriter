...
protected:	// User declarations
	...
	void __fastcall SetCaption (String &strClassName);
	...
	void __fastcall DownloadMembers (TMembers &vMembers);
	void __fastcall Clear();
	void __fastcall SaveToFile (String &strFile);
	void __fastcall InitMembersGrid ();
	bool __fastcall UploadMemberRow (int nRow, TClassMemberInfo &member);
	void __fastcall SetMemberRow (int nRow, TClassMemberInfo &class_info);
