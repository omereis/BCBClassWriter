...
//---------------------------------------------------------------------------
void __fastcall TformMain::SetMemberRow (int nRow, TClassMemberInfo &member)
{
	TObject *obj;
...
//---------------------------------------------------------------------------
void __fastcall TformMain::SaveToFile (String &strFile)
{
	TClassInfo class_info;
...
//---------------------------------------------------------------------------
void __fastcall TformMain::DownloadMembers (TMembers &vMembers)
{
...
//---------------------------------------------------------------------------
void __fastcall TformMain::SetCaption (String &strClassName)
{
